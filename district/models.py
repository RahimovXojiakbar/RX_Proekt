...
class District(BaseModel):
    ...
    governor = models.OneToOneField(Governor, on_delete=models.SET_NULL, null=True, related_name='district')
...
class DistrictStatistics(BaseModel):
    district = models.OneToOneField(District, on_delete=models.CASCADE, related_name='statistics')
    ...
    def __str__(self):
        return f"Statistics for {self.district.title}"
